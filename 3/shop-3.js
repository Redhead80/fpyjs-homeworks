...
function main() {
    let goods = [
        new Good(33, "shoes", "empty", [35,36], 3000),
        new Good(35, "hat", "empty", [35,36], 2000),
        new Good(66, "dress", "empty", [35,36], 5000),
        new Good(123, "shirt", "empty", [35,36], 3500),
        new Good(1, "scarf", "empty", [35,36], 1000),
    ]
    ...
    let basketGoods = [
        new BasketGood(33, "shoes", "empty", [35,36], 3000, 20),
        new BasketGood(35, "hat", "empty", [35,36], 2000, 0),
        new BasketGood(66, "dress", "empty", [35,36], 5000, 6),
        new BasketGood(123, "shirt", "empty", [35,36], 3500, 1),
        new BasketGood(1, "scarf", "empty", [35,36], 1000, 0),
    ]
